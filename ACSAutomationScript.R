...
texas_population <- texas_ages[1,]$estimate
harrison_population <- harrison_ages[1,]$estimate
houston_population <- houston_ages[1,]$estimate

#load languages
languages <- call_tidycensus("state", "S1601")
